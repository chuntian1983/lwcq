...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no" oncontextmenu="return false" onselectstart="return false">
    ...
    <div region="center">
        <div id="mainCenter" style="width: 100%; height: 100%;">
            <input name="rdobtn" type="radio" id="rdobtnS" value="1" checked="checked" onclick="OnSwitchingClick();" />需求信息&nbsp;&nbsp;&nbsp;&nbsp;<input
                type="radio" name="rdobtn" id="rdobtnD" value="2" onclick="OnSwitchingClick();" />供应信息
            <table id="tdg">
            </table>
        </div>
                ...
                <table class="tb" border="0px" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="rSupplyOrDemand" type="radio" value="1" checked="checked" onclick="OnCheckSupplyOrDemandClick();">需求信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                                name="rSupplyOrDemand" type="radio" value="2" onclick="OnCheckSupplyOrDemandClick();">供应信息
                        </td>
                    </tr>
                    <tr>
                        <td height="40">
