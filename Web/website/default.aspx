            ...
            <tr>
                <td>
                    ...
                    <map name="syslnks" id="syslnks">
                        <area shape="rect" coords="14, 49, 239, 90" target="_blank" href="<%=Url1 %>" 
                            alt="农村三资监管系统" />
                        <area shape="rect" coords="16, 100, 237, 137" target="_blank" href="<%=Url2 %>" 
                            alt="招投标管理系统" />
                        <area shape="rect" coords="16, 148, 237, 185" target="_blank" href="<%=Url3 %>" 
                            alt="海域使用权管理系统" />
                        <area shape="rect" coords="264, 49, 486, 89" target="_blank" href="<%=Url4 %>" 
                            alt="农村土地确权管理系统" />
                        <area shape="rect" coords="266, 100, 485, 134" target="_blank" 
                            href="<%=Url5 %>" alt="专家库管理系统" />
                        <area shape="rect" coords="266, 146, 486, 181" target="_blank" 
                            href="<%=Url6 %>" alt="宅基地使用权管理系统" />
                        <area shape="rect" coords="509, 51, 727, 87" target="_blank" href="<%=Url7 %>" 
                            alt="农村土地流转管理系统" />
                        <area shape="rect" coords="509, 100, 727, 135" target="_blank" 
                            href="<%=Url8 %>" alt="林权管理系统" />
                        <area shape="rect" coords="508, 147, 725, 180" target="_blank" 
                            href="<%=Url9 %>" alt="产权抵押管理系统" />
                        <area shape="rect" coords="745, 2, 996, 61" target="_blank" href="<%=Url10 %>" 
                            alt="农村三资查询系统" />
                        <area shape="rect" coords="746, 138, 994, 188" target="_blank" 
                            href="<%=Url12 %>" alt="供求信息发布系统" />
                            <area shape="rect" coords="748, 75, 996, 125" target="_blank" 
                            href="<%=Url11 %>" alt="村级电子公章" />
                    </map>
                </td>
            </tr>
            </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%; height: 33px; text-align: left; background-image: url(images/zcfagui.jpg); background-repeat:repeat-x; overflow:hidden;padding-left: 2px" class="font">
                                                           ...
                                                           <a id="A3"  onmouseover="tablegupai(3,2)" href="gpinfolist.aspx?typeid=3" class=gg style=" float:left; display:block;   height:31px; ">养殖水面</a>
                                                           ...
                                                           <a id="A6"  onmouseover="tablegupai(6,5)" href="gpinfolist.aspx?typeid=6" class=gg style=" float:left; display:block;   height:31px; ">集体股权</a>
                                                           ...
                                                           <a id="A11"  onmouseover="tablegupai(11,10)" href="gpinfolist.aspx?typeid=11" class=gg style=" float:left; display:block;   height:31px; ">招投标工程</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
<table class="guapai" id="Table9" style=" display:none;">
    ...
    <ItemTemplate><li><a href="shownews.aspx?lbid=<%#Eval("NewsTypeId")%>&id=<%#Eval("id")%>" target="_blank" style="text-decoration:none"><%#Eval("NewsTitle").ToString().Length > 24 ? Eval("NewsTitle").ToString().Substring(0, 24) + ".." : Eval("NewsTitle").ToString()%></a></li>
        ...
        <ul>
		   <li class="se"><a href="<%=tianqiyubao%>" target="_blank"> <img src="images/index_40.jpg" /></a></li>
        <li class="se"><a href="<%=feijihangban %>" target="_blank"> <img src="images/index_42.jpg" /></a></li>
        <li class="se"><a href="<%=changyongdianhua %>" target="_blank"> <img src="images/index_46.jpg" /></a></li>
        <li class="se"><a href="<%=renshibaokao %>" target="_blank"> <img src="images/index_48.jpg" /></a></li>
        <li class="se"><a href="<%=liecheshike %>" target="_blank"> <img src="images/index_52.jpg" /></a></li>
        <li class="se"><a href="<%=falvyuanzhu %>" target="_blank"> <img src="images/index_53.jpg" /></a></li>
        <li class="se"><a href="<%=youzhengwangdian %>" target="_blank"> <img src="images/index_56.jpg" /></a></li>
        <li class="se"><a href="<%=qichejiazhao %>" target="_blank"> <img src="images/index_57.jpg" /></a></li>
        <li class="se"><a href="<%=rencaizhaopin %>" target="_blank"> <img src="images/index_60.jpg" /></a></li>
        <li class="se"><a href="<%=huanjingzhiliang %>" target="_blank"> <img src="images/index_61.jpg" /></a></li>
		</ul>
    </div>
                                        </td>
                                    </tr>
            ...
            <tr>
                <td style="width: 1000px; background-image: url('images/tese2.jpg'); background-repeat: no-repeat;
                    height: 207px;">
    ...
    <a href="http://webscan.360.cn/index/checkwebsite/url/www.sdlwcqjy.gov.cn"><img border="0" src="http://img.webscan.360.cn/status/pai/hash/47223eec61c09212698447f01e8a6011"/></a>
</body>
</html>
