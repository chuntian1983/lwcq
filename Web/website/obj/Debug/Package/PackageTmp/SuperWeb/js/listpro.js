...
function GridView() {
    $('#tdg').datagrid({
        ...
        columns: [[
                    ...
                    { field: 'IfUp', title: '是否置顶', width: 100, align: 'left', formatter: function (value, row, index) { var u = value == 0 ? "否" : "是"; return u += "&nbsp;&nbsp;<img onclick=\"OnRowsStateClick('" + row.Id + "','IfUp','" + row.IfUp + "');\" src='../images/" + row.IfUp + ".gif' align='absmiddle' />"; } },
            ...
            handler: function () {
                ...
                if (rows.length > 0) {
                    ...
                    $.get("../ashx/listpro.ashx?action=id", { Id: rows[0].Id }, function (data) {
                        ...
                        $("#txtProType").textbox('setValue', data.ProType);
