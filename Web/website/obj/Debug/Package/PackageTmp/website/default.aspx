                                                ...
                                                <tr>
                                                    <td style="width: 363px; height: 233px; text-align: center; padding-top: 5px; vertical-align: top;">
                                                         <div class="ty" style="width:355px; text-align: left; float:left;">
                                                              <table class="guapai" id="Table11" style=" display:block;">
                                                           <tr>
                                                           <th>信息名称</th>
                                                           <th>土地用途</th>
                                                           <th>价格</th>
                                                           ...
                                                           <tr>
                                                           <td><a href='gqinfo.aspx?id=<%#Eval("id")%>'><%#Eval("ProName").ToString().Length > 6 ? Eval("ProName").ToString().Substring(0, 6) + ".." : Eval("ProName")%></a> </td>
        ...
        <li class="se"><a href="http://www.whep.gov.cn/" target="_blank"> <img src="images/index_61.jpg" /></a></li>
            ...
            <tr>
                <td align="left" class="fs" style=" background-image:url('images/yqlj.jpg'); height:30px;">
                    友情链接：<a href="http://www.agri.gov.cn/" target="_blank">农业信息网</a> | <a href="#" target="_blank">科技信息网</a>
                    | <a href="http://www.gov.cn/" target="_blank">中国政府网</a> | <a href="http://www.sdrc.agri.gov.cn/" target="_blank">荣成农业局</a>
                    | <a href="http://www.rongcheng.gov.cn/" target="_blank">荣成政府网</a> | <a href="#" target="_blank">荣成供求网</a>
                    | <a href="http://www.rcrc.gov.cn/" target="_blank">荣成人才网</a>
                </td>
            </tr>
